        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              An exciting educational game where students identify famous landmarks 
              and learn about countries around the world!
            </p>
          </motion.div>
              ...
              <Card className="p-8 bg-black/40 backdrop-blur-sm border-2 border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 group h-full">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6 text-lg">
                    Control the game, display questions on the big screen, 
                    and manage team scores. Perfect for classroom presentations!
                  </p>
              ...
              <Card className="p-8 bg-black/40 backdrop-blur-sm border-2 border-blue-500/30 hover:border-blue-400/50 transition-all duration-300 group h-full">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6 text-lg">
                    ...
                    geography knowledge! Answer first to get the chance to speak.
                  </p>
            ...
            <Card className="p-8 bg-gradient-to-r from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-gray-600/30">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <h4 className="text-xl font-bold mb-2 text-purple-400">Famous Landmarks</h4>
                  <p className="text-gray-400">
                    Explore iconic landmarks from around the world including the Eiffel Tower, 
                    Great Wall of China, Machu Picchu, and many more!
                  </p>
                </div>
                
                <div>
                  <div className="text-4xl mb-3">🎯</div>
                  <h4 className="text-xl font-bold mb-2 text-blue-400">Team Competition</h4>
                  <p className="text-gray-400">
                    5 teams compete for points. Get 1 point for correct country, 
                    2 points for detailed explanations about the landmark or country!
                  </p>
                </div>
                
                <div>
                  <div className="text-4xl mb-3">⚡</div>
                  <h4 className="text-xl font-bold mb-2 text-green-400">Real-time Interaction</h4>
                  <p className="text-gray-400">
                    Fast-paced gameplay with instant feedback, live leaderboards, 
                    and synchronized screens for the ultimate classroom experience!
                  </p>
                </div>
              </div>
            </Card>
          ...
          >
            <Card className="p-6 bg-yellow-500/10 backdrop-blur-sm border border-yellow-500/30">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div>
                  <h5 className="font-bold text-lg mb-3 text-purple-400">For Teachers:</h5>
                ...
                <div>
                  <h5 className="font-bold text-lg mb-3 text-blue-400">For Students:</h5>
                  <ol className="space-y-2 text-gray-300">
